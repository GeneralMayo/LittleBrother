...
/**
 * Created by alexmaeda on 4/11/16.
 */
/*
...
public class PopupListFragment extends ListFragment implements View.OnClickListener {
    ...
    private final String[] FAKE_DEVICES = {"Device 1", "Device 2", "Device 3"};
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        for (int i = 0, z = FAKE_DEVICES.length ; i < z ; i++) {
            items.add(FAKE_DEVICES[i]);
        }
